...
function validateForm() {
  ...
  let isAllFieldsAreFilled = validateFields();
	...
	var usSubmissionSite = "https://control.smartschoolcentral.com/sms/servlet/com.maestro.servlet.FrontFormSubmissionController";
  ...
  submissionFormElement.action = actualSubmissionSite;
    ...
    fetch(`https://control.smartschoolcentral.com/sms/v1/signup?email=${emailAddress}&verificationCode=${verificationCode}`, {
        method: 'GET',
      })
      ...
      .then((responseJson) => {
        ...
        if (!responseJson.success) {
          ...
          $.getJSON("https://control.smartschoolcentral.com/sms/api/v1/schools/schoolCode:" + schoolCode + ".jsonp?callback=?",
            function(data) {
...
function generateToken() {
  ...
  if(isEmailValid) {
    $(".fa-spinner").css("display", "inline-block");
    fetch(`https://control.smartschoolcentral.com/sms/v1/signup?email=${emailAddress}`, {
      method: 'POST',
    })
    .then(response => response.json())
    .then((responseJson) => {
